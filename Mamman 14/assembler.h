...
#define MAX_FILENAME_LENGTH 100 /* Maximum length of a file name */

/* Forward declaration of label_table to avoid including tables.h */
struct label_table;
...
void cleanup_resources(int *ICF, int *DCF, struct label_table *label_head, DataList *data_list, InstructionList *instruction_list);
